...
// @ts-expect-error — no official types for react-console-emulator
...
const Cli: React.FC<CliProps> = ({ windowName, setWindowsState, cliTheme }) => {
  const commands = {
    about: {
...
`,
    ...
    github: {
      ...
      usage: 'github',
      fn: () => {
        window.open('https://github.com/toxicbishop', '_blank')
    ...
    linkedin: {
      ...
      usage: 'linkedin',
      fn: () => {
        window.open('https://www.linkedin.com/in/pranav-arun/', '_blank')
    ...
    instagram: {
      ...
      usage: 'instagram',
      fn: () => {
        window.open('https://www.instagram.com/toxicbishop_/', '_blank')
    ...
    twitter: {
      ...
      usage: 'twitter',
      fn: () => {
        window.open('https://x.com/Pranav63076884', '_blank')
