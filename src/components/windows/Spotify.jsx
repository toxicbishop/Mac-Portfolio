...
const Spotify = ({ setWindowsState, windowName, isWifiConnected }) => {
  return (
      ...
      <div className="spotify-window">
        ...
        {!isWifiConnected ? (
          <div className="spotify-offline-screen">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="offline-icon">
